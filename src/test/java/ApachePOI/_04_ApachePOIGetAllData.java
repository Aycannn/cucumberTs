...
public class _04_ApachePOIGetAllData {
    public static void main(String[] args) throws IOException {
        ...
        String path="src/test/java/ApachePOI/resource/ApacheExcel2 (5).xlsx";

        FileInputStream inputStream=new FileInputStream(path);//throws istiyor.throws methoda imza
        Workbook workbook= WorkbookFactory.create(inputStream);//throws istiyor
