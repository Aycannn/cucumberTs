...
public class _08_WriteInTheExcel {
    public static void main(String[] args) throws IOException {
        ...
        String path="src/test/java/ApachePOI/resource/WriteInTheExcelFile (2).xlsx";
        ...
        for (int i = 1; i < 10 ; i++) {//i 1 den baslar cunku sifira deger verildi
...
//calismazsa ;yazdirirken excel kapali olacak,aciksa su an bu program kullaniliyor olarak algilar yazdirmaz
//türkce karakter kullanilmamali.import kontrol eilir gerekirse verilir.