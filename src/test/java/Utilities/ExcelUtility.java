...
public class ExcelUtility {
    ...
    public static ArrayList< ArrayList< String > > getListData(String path, String sheetName, int columnCount){
        ArrayList< ArrayList< String > > tablo=new ArrayList<>();//2 boyutlu oldugundan 2 arraylist
   //
...
//butun satirlar dolasacak kac sütun alacagini
    ...
    public static void main(String[] args) {
        ArrayList< ArrayList< String > > tablo =
                getListData("src/test/java/ApachePOI/resource/ApacheExcel2(5).xlsx","testCitizen", 4);
